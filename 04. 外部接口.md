...
*returns*: ftype-name标识的ftype类型的字节大小
*libraries*: (chezscheme)
...
*returns*: 如果obj是ftype pointer返回#t，否则返回#f
*syntax*: (ftype-pointer? ftype-name obj)
*returns*: 如果obj是ftype-name类型则返回#t，否则返回#f
*libraries*: (chezscheme)
...
*returns*: 如果ftpr1和fptr2有相同的地址返回#t，否则返回#f
*libraries*: (chezscheme)
...
*returns*: 如果fptr的地址为0返回#t，否则返回#f
*libraries*: (chezscheme)
...
*returns*: fptr的ftype, 表示为一个s-expression
libraries: (chezscheme)
...
*returns*: fptr所指向的对象的s-expression表示
*libraries*: (chezscheme)
