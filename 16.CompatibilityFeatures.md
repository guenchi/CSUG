...
[16.1节](#16.1) 描述了一个哈希表接口，此接口从现在起被 R6RS哈希表接口所取代。[16.2节](#16.2) 描述了扩展语法宏。当前版本的 Chez Scheme直接支持这些功能，但在将来的版本中可能会不再支持。新程序应改用 The Scheme Programming Language，第4版 [11]中描述的标准机制。
